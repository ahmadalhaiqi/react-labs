...
const INITIAL_STATE = {
  ...
  title: "TMR0 Application as Counter",
  introduction: "",
  step3: "",
  step5: "",
  discussion: "",
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-column mt3">
        ...
        <p>
          3. Explain the procedures taken to achieve your task and explain
          amendments done to achieve your task. Demonstrate the working program
          on PROTEUS simulation using both C and ASM source codes and write down
          your observation(s).
        </p>
        <div className="section-description mb2">
