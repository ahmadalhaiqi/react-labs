...
const INITIAL_STATE = {
  ...
  title: "Advanced I/O Programming",
  introduction: "",
  step1: "",
  step2: "",
  step4: "",
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-column mt3">
        ...
        <p>1. Write down your observation(s).</p>
        <TextareaAutosize
          onChange={handleChange}
          value={values.step1}
          name="step1"
        ...
        <p>
          2. Explain the procedures taken to achieve your task and explain the
          amendments done to achieve your task. Demonstrate the working program
          on the PIC Training Kit hardware module and write down your
          observation(s). Copy and Paste the C file to Word Doc and print.
        </p>
        <div className="section-description mb2">
        ...
        <p>3. Copy and Paste the ASM file to Word Doc and print.</p>

        <div className="section-header mt4">PROCEDURE 4</div>
        ...
        <p>4. Write down your observation(s).</p>
        <TextareaAutosize
          onChange={handleChange}
          value={values.step4}
          name="step4"
        ...
        <div className="section-header mt4">PROCEDURE 5</div>
        ...
        <p>
          5. Explain the procedures taken to achieve your task and explain the
          amendments done to achieve your task. Demonstrate the working program
          on the PIC Training Kit hardware module and write down your
          observation(s). Copy and Paste the C file to Word Doc and print.
        </p>
        ...
        <div className="section-header mt4">PROCEDURE 6</div>

        <p>6. Copy and Paste the ASM file to Word Doc and print.</p>
