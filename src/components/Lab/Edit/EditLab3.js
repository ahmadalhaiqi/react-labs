  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-column mt3">
        ...
        <p>
          2. Explain the procedures taken to achieve your task and explain how
          the interrupt is configured. Demonstrate the working program on the
          PIC Training Kit hardware module and write down your observation(s).
        </p>
        <div className="section-description mb2">
        ...
        <p>
          Q1. Is the output response of SW1 and SW2 same as the program
          flowchart?
        </p>
        <TextareaAutosize
          onChange={handleChange}
        ...
        />
        <p>
          Q2. At the end of interrupt, does the number continues or restarts
          from ‘0’? Please explain.
        </p>
        <TextareaAutosize
          onChange={handleChange}
          value={values.q2}
        ...
        />
        <p>
          Q3. What is the difference between pushing SW1 and SW2? Explain your
          answer in discussion section.
        </p>
        <TextareaAutosize
          onChange={handleChange}
          value={values.q3}
